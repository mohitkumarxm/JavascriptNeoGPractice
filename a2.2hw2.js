...
console.log("1.2");
let rajeshCollecion = 250;
let amitCollection = 350;
let isRajeshHigherCollection = rajeshCollecion > amitCollection;
console.log(
  "Does Rajesh have a higher superhit movie collection than Amit? ",
  isRajeshHigherCollection
);
console.log("---- ---- ----");
...
console.log(
  "Does Rajesh have a lower yearly income than Amit? ",
  isRajeshLessIncome
);
console.log("---- ---- ----");
...
let isRajeshMoreFans = rajeshFans < rajeshFans;
...
console.log(
  "Can I buy both a T-shirt and Jeans within my budget?",
  areBothUnderBudget
);
console.log("---- ---- ----");
console.log("2.2");
...
let averageScore = (mathsScore + englishScore + physicsScore) / 3;
...
console.log(
  "Can the product quantity be sold in batches of 5?",
  isDivisibleBy5
);
console.log(
  "Can the product quantity be sold in batches of 10?",
  isDivisibleBy10
);
