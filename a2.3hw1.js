...
let isEligibleForDramaSchool = averageMarks >= 80 || hasDramaSchoolEndorsement;
console.log("Is the user selected?", isEligibleForDramaSchool);
console.log("---- ---- ----");
...
let canWeAffordStationary =
  totalCost <= piggybank1Balance || totalCost <= piggybank2Balance;
console.log("Can you afford the purchase?", canWeAffordStationary);
console.log("---- ---- ----");
...
let meetsCriteria =
  tvScreenSize >= 50 &&
  (tvBrand === "Sony" || tvBrand === "Samsung") &&
  tvPrice <= 60000;
console.log("Does TV meet the criteria?", meetsCriteria);
console.log("---- ---- ----");
...
let isDiscountApplicable =
  2025 - watchReleaseYear === 1 &&
  (watchSize === "M" || watchSize === "L") &&
